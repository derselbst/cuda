...
\centering
 ...
 \begin{axis}[
   ...
   use comma,
   1000 sep={},
   xlabel=Anzahl Datensätze,xmode = log,log basis x={2},
   ylabel=Berechnungszeit in ms]
 \addplot table [x=N,y=Kaos]{test};
  \addplot table [x=N,y=Ksoa]{test};
   \addplot table [x=N,y=Caos]{test};
    \addplot table [x=N,y=Csoa]{test};
